        ...
        <div className="absolute inset-0 flex flex-col lg:top-20 top-10  left-20 text-white ">
          ...
          <div className="z-10 relative">
            ...
            <div className="flex mt-4 ">
              <button className="bg-purchase-button hover:bg-blue-600 text-lg text-white font-semibold py-2 px-4 rounded-xl w-40  font-montserrat mr-2" onClick={handleClick}>
                Start Now
              </button>
              <button className="bg-navbar border-2 border-contour hover:bg-blue-600 text-lg text-white font-semibold  font-montserrat py-2 px-4 rounded-xl">
                Contact Sales
              </button>
            </div>
          </div>
